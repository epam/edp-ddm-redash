...
import QueryBasedParameterInput from "@/components/QueryBasedParameterInput";
...
class ParameterValueInput extends React.Component {
  ...
  renderQueryBasedInput() {
    //console.log('renderQueryBasedInput', this.props.globalParameters);
    ...
    return (
      <QueryBasedParameterInput
        ...
        registerParameterItem={this.props.registerParameterItem}
        {...multipleValuesProps}
      />
    );
  }
