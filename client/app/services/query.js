...
const QueryService = {
  ...
  asDropdown: ({id, params}) => axios.get(`api/queries/${id}/dropdown`, {params: params}),
  associatedDropdown: ({ queryId, dropdownQueryId, params }) =>
    axios.get(`api/queries/${queryId}/dropdowns/${dropdownQueryId}`, {params: params}),
