...
from redash.utils import mustache_render, json_loads, user_mustache_render
...
class ParameterizedQuery(object):
    ...
    def user_apply(self, attributes):
        self.query = user_mustache_render(self.query, attributes)
