...
def sp_initiated(org_slug=None):
    ...
    if saml_redirect_url:
        redirect_url = parse.urlparse(redirect_url)
        saml_redirect_url = parse.urlparse(saml_redirect_url)

        redirect_url = redirect_url._replace(netloc=saml_redirect_url.netloc)
        redirect_url = parse.urlunparse(redirect_url)
